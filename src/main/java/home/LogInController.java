...
public class LogInController
{
    ...
    protected void onSignIn() throws IOException
    {
        ...
        if (username.isEmpty()) {
            ...
            fxmlLoader.setLocation(getClass().getResource("/views/customers-view.fxml"));
    ...
    private boolean userFound(String username, String password) {
        Optional<User> user = DataManager.users.stream().filter(u -> u.getUsername().equals(username) && u.getPassword()
