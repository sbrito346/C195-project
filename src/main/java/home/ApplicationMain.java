...
public class ApplicationMain extends Application
{
    ...
    {
        FXMLLoader fxmlLoader = new FXMLLoader(ApplicationMain.class.getResource("/views/logIn-view.fxml"));
    ...
    public static ResourceBundle getLogInBundle() {
        return ResourceBundle.getBundle("home.LogInForm", Locale.getDefault());
    }
