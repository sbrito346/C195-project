...
public class Customer {
    ...
    public void addAppointment(Appointment appointment) {
        ...
        int newId = DataManager.insertAppointment(appointment);
    ...
    public void removeAppointment(Appointment appointment) {
        DataManager.removeAppointment(appointment);
        this.appointments.remove(appointment);
        DataManager.appointments.remove(appointment);
    }
    ...
    public void editAppointment(Appointment appointment) {
        ...
        Optional<Appointment> globalAppointment = DataManager.appointments.stream().filter(c -> c.getId() == appointment.getId()).findFirst();
        if (globalAppointment.isPresent()) {
            DataManager.appointments.set(DataManager.appointments.indexOf(globalAppointment.get()), appointment);
        }
    }
